                ...
                <section data-section="overview" className="mb-12">
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-4">
                      At Crystal Beauty Clear, we believe that your personal
                      information should remain personal. This Privacy Policy
                      explains how we collect, use, disclose, and safeguard your
                      information when you visit our website, use our mobile
                      application, or make purchases from us.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
                      We are committed to transparency and will never sell your
                      personal data to third parties. Your trust is the
                      foundation of our relationship, and we take that
                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-amber-100/50 p-6 rounded-2xl">
                      ...
                      <ul className="space-y-2 text-gray-700">
                        <li className="flex items-start">
                          ...
                          <span>
                            Website interactions, pages visited, and time spent
                          </span>
                        </li>
                        <li className="flex items-start">
                          <div className="w-2 h-2 bg-amber-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white/60 p-6 rounded-2xl border border-orange-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        customer support, and deliver the products and services
                        you've requested.
                      </p>
                    </div>
                    <div className="bg-white/60 p-6 rounded-2xl border border-orange-200">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        We personalize your experience with product
                        recommendations, tailored content, and customized
                        communications.
                      </p>
                    </div>
                    <div className="bg-white/60 p-6 rounded-2xl border border-orange-200">
                ...
                <section data-section="information-sharing" className="mb-12">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-6">
                    ...
                    <p className="text-red-700">
                      Crystal Beauty Clear will never sell, rent, or trade your
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        help us operate our business (shipping, payment
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        merger or acquisition (with continued privacy
                        protection)
                      </span>
                    </li>
                  </ul>
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-2xl p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Deliver relevant advertisements and track campaign
                          effectiveness
                        </p>
                      </div>
                    </div>
                ...
                <section data-section="contact" className="mb-8">
                  ...
                  <div className="bg-gradient-to-r from-orange-50 to-orange-100/50 p-8 rounded-2xl">
                    <p className="text-gray-700 leading-relaxed mb-6">
                      ...
                      exercise your privacy rights, please don't hesitate to
                      contact us. We're committed to addressing your concerns
                      promptly.
                    </p>
                    <div className="grid md:grid-cols-3 gap-6 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-600">privacy@cbc.com</p>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mb-3">
                        ...
                        <p className="text-sm text-gray-600">0112212311</p>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mb-3">
...
export default CBCPrivacyPolicy;
