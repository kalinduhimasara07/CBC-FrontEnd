...
export default function Homepage() {
  ...
  return (
    <div className="w-full">
      <div className="h-screen w-full mt-[80px] bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
        {/* Hero Section */}
        <div className="w-full relative overflow-hidden bg-gradient-to-r from-amber-600 to-orange-600 text-white min-h-screen flex items-center">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl lg:text-2xl text-amber-100 leading-relaxed mb-8">
                  ...
                  Transform your routine with products designed for real
                  results.
                </p>
              ...
              <div className="relative">
                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                  <div className="text-center mb-6 flex flex-col justify-center items-center">
                    ...
                    <div className="bg-white m-3 px-10 md:px-30 py-4 rounded-2xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    "95% of users see visible improvement in 4 weeks",
                },
                {
                  icon: "♻️",
                  title: "Sustainable",
